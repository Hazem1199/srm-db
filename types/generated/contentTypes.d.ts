...
export interface ApiTaskTask extends Schema.CollectionType {
  ...
  attributes: {
    taskNum: Attribute.Integer & Attribute.Required & Attribute.Unique;
    taskName: Attribute.String & Attribute.Required;
    Department: Attribute.String & Attribute.Required;
    taskLink: Attribute.String & Attribute.Required;
    taskType: Attribute.Enumeration<['task', 'sheet']> & Attribute.Required;
    taskDay: Attribute.Enumeration<
      ['Everyday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday']
    > &
      Attribute.Required;
    from: Attribute.Time & Attribute.Required;
    to: Attribute.Time;
    taskLateness: Attribute.Time;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
